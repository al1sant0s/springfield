...
urlpatterns = [
    ...
    path("<uuid:device_id>/proxy/identity/pids//personas", views.pids_personas, name="pids_personas"),
    path("<uuid:device_id>/proxy/identity/pids/<int:user_id>/personas", views.user_id_personas , name="user_id_personas"),
    path("<uuid:device_id>/proxy/identity/personas", views.personas, name="personas"),
