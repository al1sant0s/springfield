...
- HCAPTCHA_SITEKEY: frontend captcha key for the "Delete User" form in the dashboard.

- HCAPTCHA_SECRET: backend key to validate the captcha during user deletion.
